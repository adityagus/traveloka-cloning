  ...
  return (
    <section className="hotels-form w-full flex flex-center flex-col">
      ...
      <div className="bg-white -mt-52 rounded-xl shadow-lg" style={{ width: "800px" }}>
        <div class="bg-slate-300 text-colors-primary-blue py-4 rounded-t-lg flex gap-2 px-2 font-medium">
          <span>
            <svg
              width="24"
              height="24"
        ...
        <div class="w-full text-gray-500 px-4 py-4">
          <div class="input">
            <label className="mb-3" for="kota">
              Kota, tujuan, atau nama hotel
            </label>
            <div class="mt-1 flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-colors-primary-blue">
          ...
          <div class="grid grid-cols-3 mt-3">
            ...
            <div class="input ml-4">
              ...
              <div class="text-black font my-2">
                Jum, 07 Feb 2025
              </div>
            </div>
          </div>
          ...
          <div class="input ml-4">
            <br className="mb-3"/>
            <div class={`mt-1 flex items-center rounded-md bg-orange-500  outline outline-1 -outline-offset-1 outline-orange-500 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-colors-primary-blue ${isLoading && "hidden"}`}>
          ...
          <div class="flex text-colors-primary-blue mt-4 ml-2">
          <div class="">
